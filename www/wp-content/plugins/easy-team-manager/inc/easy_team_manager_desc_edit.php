...
<tr><th></th><td><?php if ($ind_image!=is_numeric($ind_image)){?><img src='<?php $upload_dir=wp_upload_dir();
						echo $upload_dir["url"]."/"."easy_team_manager/".$ind_image;?>' style="height:128px; width:auto; float:left; border:1px solid #ddd; border-radius:3px; padding:6px; background:#fff;"><?php } else {?><img src='<?php echo plugins_url('easy-team-manager/images/blank_pic.png');?>'style="height:128px; width:auto; float:left; border:1px solid #ddd; border-radius:3px; padding:6px; background:#fff;"><?php }?></td></tr>
        <tr>
