...
$setting_list=unserialize($get_result->setting);?>
    ...
    <section class="the_team" style=" <?php if($setting_list['img_set']!="unset"){ $upload_dir=wp_upload_dir();?> background:url(<?php echo $upload_dir["url"]."/"."easy_team_manager/".$get_result->background_image;?>);<?php } else {?> background:<?php echo $setting_list['background_color'];?>;<?php }?>">
        <div>
            ...
            <div class="team_member_wrap">
                <div class="team_profile_wrap" style=" <?php if($ind_email_detail['sh']=='s_email' && $ind_phone_detail['sh']=='s_phone' ){?>height:355px !important; <?php } else if( $ind_email_detail['sh']=='h_email' && $ind_phone_detail['sh']=='s_phone'){?> height:285px !important;<?php }else if( $ind_email_detail['sh']=='s_email' && $ind_phone_detail['sh']=='h_phone'){?> height:280px !important;<?php }?>  border-color:<?php echo $team_manager_color['theme_color'] ;?>;">
                   ...
                   <div class="team_profile_pic" style=" <?php if($row->image!=is_numeric($row->image)){ $upload_dir=wp_upload_dir();?> background:url(<?php echo $upload_dir["url"]."/"."easy_team_manager/".$row->image;?>) no-repeat center center transparent;
