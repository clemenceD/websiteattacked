        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="contact-address wow bounceInLeft">
                    ...
                    <h3><?php the_field("section_form_left_adress"); ?></h3>
                    <p><?php the_field("section_form_left_adress_content"); ?></p>
                    <h3><?php the_field("section_form_left_call_us"); ?></h3>
                    <p><?php the_field("section_form_left_phone"); ?></p>
                    <h3><?php the_field("section_form_left_write_us"); ?></h3>
                    <p><?php the_field("section_form_left_email_contact"); ?></p>    
                ...
                <div class="contact-form wow bounceInRight">
                    ...
                    <div class="row">
                        <div class="col-xs-6 input-name">
                            <input name="ename" id="ename" type="text" class="input-field" placeholder="<?php the_field("section_form_name"); ?>">
                        </div>
                        <div class="col-xs-6 input-email">
                            <input id="eemail" name="eemail" type="text" class="input-field " placeholder="<?php the_field("section_form_email"); ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <input id="esubject" name="esubject" type="text" class=" input-field" placeholder="<?php the_field("section_form_subject"); ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <textarea id="emessage" name="esubject" class="input-message" rows="4" cols="50" placeholder="<?php the_field("section_form_message"); ?>"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="contact-form-action">
                                <button id="sendmail" class="btn btn-send"><?php the_field("section_form_button"); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
