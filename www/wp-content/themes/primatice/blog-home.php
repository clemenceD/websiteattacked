...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="logo">
                        <a href="<?php echo site_url();?>" title="Primatice"><img
                                src="/wp-content/themes/primatice/img/logo.png"
                                alt="Primatice"></a>
                    </div>
                </div>
                <div class="col-md-9">
                     <div class="navigation collapse navbar-collapse bs-js-navbar-collapse clearfix"
                             id="smoothmenu1">
                              <div id="flags_language_selector" class="pull-right"><?php language_selector_flags(); ?></div >
                            <?php
                            $defaults = array(
    ...
    <section class="inner-page-header feature-blog overlay-section">
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <?php if (!is_single() && !is_page()) { ?>
                                    <?php // the_excerpt(); ?>
                                    <a href="<?php echo get_permalink(); ?>" class="more">permalink : <?php the_title() ?></a>
                                <?php } ?>
