(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".section-intro").fitText(1, { minFontSize: '14px', maxFontSize: '20px' });
         ...
         $('body').on('click', '.top-menu li.scroll_to a, .scroll_to', function(){
        ...
        $('.top-menu').onePageNav({
            ...
            currentClass: 'active',
            easing: 'easeInExpo',
            filter: '.top-menu li.scroll_to a'
        });
...
function headFix(){
    ...
    if($(window).width() < 1000 ){
        ...
        console.log("ix");
                    ...
                    $('#home_banner .content').css('margin-top','18.333%');

           }else {
            $('#home_banner .content').css('margin-top','14.3333%');
           }

           if($(window).width() < 450 ){

             $('#home_banner h1').css('font-size','3em');
              $('#home_banner h3').css('font-size','2.5em');
               $('#home_banner').css('height','320px');

           }

           if($(window).width() > 450 ){

            $('#home_banner h1').css('font-size','4em');
              $('#home_banner h3').css('font-size','3.5em');
               $('#home_banner').css('height','488px');
